...
// GET /api/locations/latest - Fetch latest location for every vehicle
router.get('/latest', async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error fetching latest locations', error: err.message });
  }
});
